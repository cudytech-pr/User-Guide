...
## Overview
- View the Mesh's appearance — [front](overview_m3000.md#front-panel){ data-preview } and [back](overview_m3000.md#back-panel){ data-preview }.
- Check the [LED](overview_m3000.md#front-panel){ data-preview } status and indication.
- Check the [interfaces](overview_m3000.md#back-panel){ data-preview } layout and instructions. 
