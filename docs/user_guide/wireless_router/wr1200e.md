...
- *Wireless 5G* shows the Wireless 5G status. Click [*More Details*](wireless_5g.md){ data-preview } to know more information about it or make changes on Settings page. 
...
- [Wireless 5G](wireless_5g.md){ data-preview }: is to customize the router's 5G wireless settings, including SSID and password, mode, channel, channel width and transmit power, and so on.
