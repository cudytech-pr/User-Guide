...
## Overview
- Check the [package content](overview_wr11000.md#package-content){ data-preview }.
- View the router's appearance—[front](overview_wr11000.md#front-panel){ data-preview } and [back](overview_wr11000.md#back-panel){ data-preview }.
- View the [interfaces](overview_wr11000.md#back-panel){ data-preview } layout and description. 
- Check the [LED](overview_wr11000.md#front-panel){ data-preview } status and indication.
...
- *Wireless 6G* shows the Wireless 6G status. Click [*More Details*](wireless_6g.md){ data-preview } to know more information about it or make changes on Settings page. 
