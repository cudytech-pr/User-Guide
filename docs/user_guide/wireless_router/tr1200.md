...
## Overview
- Check the [package content](overview_tr1200.md#package-content){ data-preview }.
- View the router's appearance—[front](overview_tr1200.md#front-panel){ data-preview } and [back](overview_tr1200.md#back-panel){ data-preview }.
- View the [interfaces](overview_tr1200.md#back-panel){ data-preview } layout and description. 
- Check the [LED](overview_tr1200.md#front-panel){ data-preview } status and indication.
...
- [Wireless](wireless.md){ data-preview }: Customize the router's wireless settings, including SSID and password, mode, channel, channel width and transmit power, and so on.
...
- [USB Sharing](usb.md#usb-sharing-settings){ data-preview }: Allow to store or share files/data via USB storage device. 
...
- [Toggle Button](system.md#toggle-button){ data-preview }: Configure the toggle button to control VPN or LED.
