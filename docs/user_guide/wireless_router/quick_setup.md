...
5. Select your *Operation Mode* accordingly.  
    ...
    <p style="font-size: 0.85em; color: #555;">(* Some earlier versions may not support all five modes.)</p>
...
8. Customize your 2.4G/5G wireless network name (SSID) and password. 
    ...
    <p style="font-size: 0.85em; color: #555;">(* Dual-band wireless setting is for example here, and it may vary by model.)</p>
