...
## Overview
- Check the [package content](overview_wr1300s.md#package-content){ data-preview }.
- View the router's appearance—[front](overview_wr1300s.md#front-panel){ data-preview } and [back](overview_wr1300s.md#back-panel){ data-preview }.
- View the [interfaces](overview_wr1300s.md#back-panel){ data-preview } layout and description. 
- Check the [LED](overview_wr1300s.md#front-panel){ data-preview } status and indication.
...
- *USB* shows the USB 3.0 port connection status. Click [*More Details*](usb.md){ data-preview } to know more information about it or make changes on Settings page. 
...
- [USB](usb.md#usb-sharing-settings){ data-preview }: Allow to store or share files/data via USB storage device. 
