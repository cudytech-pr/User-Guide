[<<< Back to Industrial Router](index.md)

# IR04

## Overview
- Check the [package content](overview_ir04.md#package-content){ data-preview }.
- View the router's [appearance](overview_ir04.md#appearance){ data-preview }.
- View the [interfaces](overview_ir04.md#interfaces){ data-preview } layout. 
- Check the [LED indicators](overview_ir04.md#leds){ data-preview } status.
...
-----
## Manage
### I. [System Status](status.md){ data-preview }
...
- [*Mesh*](mesh.md){ data-preview } shows the router’s Mesh network status (SOLE or MESH), the mesh device name and the amount of mesh units. Click *More Details* to know more information or add/manage mesh unit(s).
- [*Devices*](status.md#devices){ data-preview } shows the amount of devices connected to this router, and the connection method being 2.4G WiFi or Wired; while the Mesh device will be not be displayed here but on the *More Details* page.
- [*Cellular*](cellular.md){ data-preview } shows whether the router has connected to the cellular network, its network type and upload/download rate. Click *More Details* to know more information on the *Status* and *Statistics* sub-pages, or configure some *settings*.
- [*LAN*](network.md#lan){ data-preview } shows whether the router has connected to the cellular network, its network type and upload/download rate. Click *More Details* to know more information on the *Status* and *Statistics* sub-pages, or configure some *settings*.
- [*Wireless 2.4G*](wireless_2.4g.md){ DATA-PREVIEW } shows whether the router has connected to the cellular network, its network type and upload/download rate. Click *More Details* to know more information on the *Status* and *Statistics* sub-pages, or configure some *settings*.
- [*DHCP Server*](network.md#dhcp-server){ data-preview } shows whether the router has connected to the cellular network, its network type and upload/download rate. Click *More Details* to know more information on the *Status* and *Statistics* sub-pages, or configure some *settings*.
- [*System*](status.md){ data-preview } shows whether the router has connected to the cellular network, its network type and upload/download rate. Click *More Details* to know more information on the *Status* and *Statistics* sub-pages, or configure some *settings*.
