...
## Overview
- Check the [package content](overview_ir02.md#package-content){ data-preview }.
- View the router's [appearance](overview_ir02.md#appearance){ data-preview }.
- View the [interfaces](overview_ir02.md#interfaces){ data-preview } layout. 
- Check the [LED indicators](overview_ir02.md#leds){ data-preview } status.

## Install
- [Install](install_power_ir02.md#install-sim-cards){ data-preview } nano SIM card(s).
- [Install](install_power_ir02.md#install-antennas){ data-preview } 4G and WiFi antenna(s).
- [Mount](install_power_ir02.md#install-router){ data-preview } the router on the wall or DIN-rail.

## Power
- There are two methods to provide [power supply](install_power_ir02.md#power-supply){ data-preview } for the router.
...
- *System* shows whether the router has connected to the cellular network, its network type and upload/download rate. Click [*More Details*](status.md#system){ data-preview } to know more information on the *Status* and *Statistics* sub-pages, or configure some *settings*.
