...
You may go to *General Settings -> Wireless* or *System Status -> Wireless 2.4G/5G -> More Details -> Settings* to configure this feature.

<img src="https://cdn.jsdelivr.net/gh/Cudytech-pr/User-Guide/docs/images/4g5g_router/wireless.webp" alt="" width="800px" style="border: 1px solid #eee;" />
...
4. Click *Advanced* and continue with the following steps, otherwise just click *Save & Apply*.
4. Select a proper *Mode*, *Channel*, *Channel Width* and *Transmit Power*.
5. Enter the maximum number of devices you want to allow on your network in the *Max Stations* field.
