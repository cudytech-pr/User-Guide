...
## Overview
- Check the [package content](overview_p4.md#package-content){ data-preview }.
- View the router's appearance—[front](overview_p4.md#front-panel){ data-preview } and [back](overview_p4.md#back-panel){ data-preview }.
- View the [interfaces](overview_p4.md#back-panel){ data-preview } layout and description. 
- Check the [LED](overview_p4.md#front-panel){ data-preview } status and indication.

## [Quick Installation Guide](qig.md){ data-preview }
...
- *Status* shows whether the router has connected to the Internet or not, and its work mode and interface. Click [*Quick Setup*](qig.md){ data-preview } to redirect to the *Quick Setup* page.
...
- *5G* shows the cellular network status, SIM card status and APN profile type. Click [*More Details*](cellular.md){ data-preview } to know more information about it or make changes on Settings page. 
