...
## Overview
- Check the [package content](overview_lt300.md#package-content){ data-preview }.
- Check the front panel for the [LED](overview_lt300.md#front-panel){ data-preview } status and indication.
- Check the back panel for the [interfaces and buttons](overview_lt300.md#back-panel){ data-preview } description. 
