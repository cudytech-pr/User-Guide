...
2. Open the Cudy App on your phone. Tick *I agree with ...* and select *Local Management*.
    ...
    ???+ Tip
        ...
        <img src="https://cdn.jsdelivr.net/gh/Cudytech-pr/User-Guide/docs/images/downloadapp.svg" width="200px" style="display: block; margin: 0 auto;">   
...
6. Scroll down and tap *More*.
    <img src="https://cdn.jsdelivr.net/gh/Cudytech-pr/User-Guide/docs/images/tutorial/vpn/more.webp" width="300px" style="border:  2px solid #eee;display: block; margin: 0 auto;">   

7. Find and tap *VPN*.
    <img src="https://cdn.jsdelivr.net/gh/Cudytech-pr/User-Guide/docs/images/tutorial/vpn/vpn.webp" width="300px" style="border:  2px solid #eee;display: block; margin: 0 auto;">   

8. Tap *VPN Client*.
    <img src="https://cdn.jsdelivr.net/gh/Cudytech-pr/User-Guide/docs/images/tutorial/vpn/vpn_client.webp" width="300px" style="border:  2px solid #eee;display: block; margin: 0 auto;">   

9. Tap *Add*.
    <img src="https://cdn.jsdelivr.net/gh/Cudytech-pr/User-Guide/docs/images/tutorial/vpn/add_vc.webp" width="300px" style="border:  2px solid #eee;display: block; margin: 0 auto;">   

10. Tap *Surfshark*.
    <img src="https://cdn.jsdelivr.net/gh/Cudytech-pr/User-Guide/docs/images/tutorial/vpn/add_surfshark.webp" width="300px" style="border:  2px solid #eee;display: block; margin: 0 auto;">   

11. Enter your Surfshark account *Username* and *Password*, and click *Continue*. 
    <img src="https://cdn.jsdelivr.net/gh/Cudytech-pr/User-Guide/docs/images/tutorial/vpn/surfshark_account.webp" width="300px" style="border:  2px solid #eee;display: block; margin: 0 auto;">   
...
12. Select a *Default Rule* and *VPN Policy*. Search and select a server. Tap the ✔ icon at the top right to save and apply.
    <img src="https://cdn.jsdelivr.net/gh/Cudytech-pr/User-Guide/docs/images/tutorial/vpn/surfshark_config.webp" width="300px" style="border:  2px solid #eee;display: block; margin: 0 auto;">   
...
13. Toggle on to activate this VPN client profile. You can view, edit, or delete this profile as needed.
    <img src="https://cdn.jsdelivr.net/gh/Cudytech-pr/User-Guide/docs/images/tutorial/vpn/surfshark_connected.webp" width="300px" style="border:  2px solid #eee;display: block; margin: 0 auto;">   
...
2. Go to *General Settings > VPN > VPN Client*. Click *Add*.
    <img src="https://cdn.jsdelivr.net/gh/Cudytech-pr/User-Guide/docs/images/tutorial/vpn/vpn1.webp" width="700px" style="border:  2px solid #eee;display: block; margin: 0 auto;">   

3. Click *Surfshark* in the VPN Client pop-up window.
    <img src="https://cdn.jsdelivr.net/gh/Cudytech-pr/User-Guide/docs/images/tutorial/vpn/vpn2.webp" width="700px" style="border:  2px solid #eee;display: block; margin: 0 auto;">   

4. Enter your Surfshark account *Username* and *Password*, and click *Continue*. 
    <img src="https://cdn.jsdelivr.net/gh/Cudytech-pr/User-Guide/docs/images/tutorial/vpn/vpn3.webp" width="700px" style="border:  2px solid #eee;display: block; margin: 0 auto;">   
...
5. Create a *Description*, select a *Default Rule* and *VPN Policy*. Search and select a server. Click *Save & Apply*.
    <img src="https://cdn.jsdelivr.net/gh/Cudytech-pr/User-Guide/docs/images/tutorial/vpn/vpn5.webp" width="700px" style="border:  2px solid #eee;display: block; margin: 0 auto;">   
...
6. Toggle *Enable* to activate this VPN client profile. You can view, edit, or delete this profile as needed.
    <img src="https://cdn.jsdelivr.net/gh/Cudytech-pr/User-Guide/docs/images/tutorial/vpn/vpn7.webp" width="700px" style="border:  2px solid #eee;display: block; margin: 0 auto;">   